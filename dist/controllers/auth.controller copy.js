...
exports.refreshAccessToken = exports.logoutUser = exports.getUserData = exports.loginUser = exports.registerUser = exports.googleCallback = exports.authGoogle = void 0;
...
exports.refreshAccessToken = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res
            ...
            .cookie("accessToken", accessToken, constants_1.cookieOption)
            .cookie("refreshToken", refreshToken, constants_1.cookieOption)
            .json(new ApiResponse_1.default(200, {}, "Access Token Refreshed"));
    }
    catch (error) {
